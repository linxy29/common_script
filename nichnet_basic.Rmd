...
```{r}
## sender
sender_celltypes = c("Cardiac mesoderm","Mesoderm", "Endoderm")
...
sender_celltypes = c("Cardiac mesoderm", "Endoderm") ## cell numbers in NOTOSB - Mesoderm is too low, remove Mesoderm
```
