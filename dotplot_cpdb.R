...
# Useage: Rscript /home/linxy29/Code/common_script/dotplot_cpdb.R ./out/
...
### Example parameters
#cpdbPath <- "/storage/holab/linxy/iPSC/day7_cpdb/out" # The path to the seurat object. It should be save as RDS file
